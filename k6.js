...
export default function () {
  ...
  let url = 'http://localhost:3000/api/carousel';
  ...
  http.get(`http://localhost:3000/api/carousel/${id}/moreToConsider`);
  http.get(`http://localhost:3000/api/carousel/${id}/similar`);
  http.get(`http://localhost:3000/api/carousel/${id}/featured`);
